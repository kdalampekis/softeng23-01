...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='NameProfile',
            fields=[
                ('ActorName', models.CharField(max_length=50, primary_key=True, serialize=False)),
                ('ActorNconst', models.CharField(blank=True, max_length=20, null=True)),
                ('AllGenres', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
